...
// their stats) were relocated, unchanged, into balancer_select.h so the NPU
// pipeline's SELECT-stage core can reuse them from its own translation unit.
#include "katran/lib/bpf/balancer_select.h"
...
// update_vip_lru_miss_stats / check_and_update_real_index_in_lru /
// incr_server_id_routing_stats / check_udp_flow_migration were relocated,
// unchanged, into balancer_select.h (included above).
